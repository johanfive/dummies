    ...
    /******/
    {
      ...
      function (module, exports, __webpack_require__) {
        ...
        (function (module) {
          ...
          var colorConvert = __webpack_require__(
          /*! color-convert */
      ...
      function (module, exports, __webpack_require__) {
        ...
        /*! color-name */
        "./node_modules/color-name/index.js"); // NOTE: conversions should only return primitive values (i.e. arrays, or
      ...
      function (module, exports, __webpack_require__) {
        ...
        var _ansiStyles = _interopRequireDefault(__webpack_require__(
        /*! ansi-styles */
        "./node_modules/ansi-styles/index.js"));
        ...
        var _AsymmetricMatcher = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/AsymmetricMatcher */
        "./packages/pretty-format/src/plugins/AsymmetricMatcher.ts"));

        var _ConvertAnsi = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/ConvertAnsi */
        "./packages/pretty-format/src/plugins/ConvertAnsi.ts"));

        var _DOMCollection = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/DOMCollection */
        "./packages/pretty-format/src/plugins/DOMCollection.ts"));

        var _DOMElement = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/DOMElement */
        "./packages/pretty-format/src/plugins/DOMElement.ts"));

        var _Immutable = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/Immutable */
        "./packages/pretty-format/src/plugins/Immutable.ts"));

        var _ReactElement = _interopRequireDefault(__webpack_require__(
        /*! ./plugins/ReactElement */
        "./packages/pretty-format/src/plugins/ReactElement.ts"));

        var _ReactTestComponent = _interopRequireDefault(__webpack_require__(
      ...
      function (module, exports, __webpack_require__) {
        ...
        var _ansiRegex = _interopRequireDefault(__webpack_require__(
        /*! ansi-regex */
        "./node_modules/ansi-regex/index.js"));
      ...
      function (module, exports, __webpack_require__) {
        ...
        var ReactIs = _interopRequireWildcard(__webpack_require__(
        /*! react-is */
        "./node_modules/react-is/index.js"));
      ...
      function (module, exports, __webpack_require__) {
        ...
        var _escapeHTML = _interopRequireDefault(__webpack_require__(
        /*! ./escapeHTML */
        "./packages/pretty-format/src/plugins/lib/escapeHTML.ts"));
...
},{}],"SGkm":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.codeStringStyle = exports.componentBlockStyle = exports.wrapperStyle = void 0;
...
var componentBlockStyle = function componentBlockStyle() {
  return {
    padding: padding
  };
};

exports.componentBlockStyle = componentBlockStyle;

var codeStringStyle = function codeStringStyle() {
  return {
    background: '#f5f5f5',
    border: border,
    margin: 0,
...
exports.codeStringStyle = codeStringStyle;
},{}],"hi2F":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DemoBox = void 0;
...
var DemoBox = function DemoBox(_ref) {
  var children = _ref.children,
      funcStrings = _ref.funcStrings,
      style = _ref.style;
  var formatted = (0, _prettyFormat.default)(children, {
    plugins: [_prettyFormat.default.plugins.ReactElement],
    printFunctionName: false
  }).replace(/Object {/g, '{').replace(/Array \[/g, '[');

  if (funcStrings) {
    var replaceFunc = function replaceFunc(str) {
      return formatted = formatted.replace('[Function]', str);
    };
  ...
  return _react.default.createElement("div", {
    style: (0, _styles.wrapperStyle)(style)
  }, _react.default.createElement("div", {
    style: (0, _styles.componentBlockStyle)()
  }, children), _react.default.createElement("pre", {
    style: (0, _styles.codeStringStyle)()
  }, formatted));
};

exports.DemoBox = DemoBox;
},{"react":"n8MK","pretty-format":"eYyk","./styles":"SGkm"}],"nam8":[function(require,module,exports) {
"use strict";
...
var PropRow = function PropRow(_ref2) {
  ...
  return _react.default.createElement("tr", {
    style: bgColor
  }, _react.default.createElement(Cell, null, name), _react.default.createElement(Cell, null, types.join(', ')), _react.default.createElement(Cell, null, required ? 'Required' : 'Optional'), _react.default.createElement(Cell, null, notes), _react.default.createElement(Cell, null, examples));
};

var PropsTable = function PropsTable(_ref3) {
  ...
  }, _react.default.createElement("thead", null, _react.default.createElement("tr", null, _react.default.createElement("th", null, "Name"), _react.default.createElement("th", null, "Types"), _react.default.createElement("th", null, "Required"), _react.default.createElement("th", null, "Notes"), _react.default.createElement("th", null, "Examples"))), _react.default.createElement("tbody", null, props.map(function (_ref4, i) {
    var name = _ref4.name,
        types = _ref4.types,
        required = _ref4.required,
        notes = _ref4.notes,
        examples = _ref4.examples;
    return _react.default.createElement(PropRow, {
      key: i,
      index: i,
      name: name,
      types: types,
...
},{"react":"n8MK"}],"JAGQ":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "DemoBox", {
  enumerable: true,
  get: function () {
    return _DemoBox.DemoBox;
  }
});
Object.defineProperty(exports, "PropsTable", {
  enumerable: true,
  get: function () {
    return _PropsTable.PropsTable;
  }
});

var _DemoBox = require("./DemoBox");

var _PropsTable = require("./PropsTable");
},{"./DemoBox":"hi2F","./PropsTable":"nam8"}],"uZ6V":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.demoBoxProps = void 0;
...
var demoBoxProps = [{
  ...
  notes: _react.default.createElement("div", null, "The DemoBox component relies on Jest's \"pretty-format\" to render the code string.", _react.default.createElement("br", null), "Unfortunately \"pretty-format\" will replace each function with the string \"[Function]\".", _react.default.createElement("br", null), "The funcStrings prop of DemoBox is there to cancel out this behaviour:"),
  examples: _react.default.createElement("pre", {
    style: {
      textAlign: 'left'
    }
  }, "\u2219 \"() => console.log('Replaces [Function] with this string')\"\n\u2219 [\n    \"() => console.log('Replaces [Function] with this string')\",\n    \"() => console.log('Replaces nth [Function] with nth string')\"\n  ]")
}];
exports.demoBoxProps = demoBoxProps;
},{"react":"n8MK"}],"x9yp":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.useOverflowTracker = void 0;
...
var useOverflowTracker = function useOverflowTracker() {
  var ref = (0, _react.useRef)(null);

  var _useState = (0, _react.useState)(initialState),
      _useState2 = _slicedToArray(_useState, 2),
      overflowOn = _useState2[0],
      setOverflowOn = _useState2[1];

  var _useWindowSize = (0, _.useWindowSize)(),
      _useWindowSize2 = _slicedToArray(_useWindowSize, 2),
      maxWidth = _useWindowSize2[0],
      maxHeight = _useWindowSize2[1];

  (0, _react.useEffect)(function () {
    var coordinates = ref.current.getBoundingClientRect();
    setOverflowOn({
...
exports.useOverflowTracker = useOverflowTracker;
},{"react":"n8MK","./":"FDhl"}],"KTAQ":[function(require,module,exports) {
"use strict";
...
},{"react":"n8MK"}],"FDhl":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "useOverflowTracker", {
  enumerable: true,
  get: function () {
    return _useOverflowTracker.useOverflowTracker;
  }
});
...
var _useOverflowTracker = require("./useOverflowTracker");

var _useWindowSize = require("./useWindowSize");
},{"./useOverflowTracker":"x9yp","./useWindowSize":"KTAQ"}],"Y8Wc":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.BorderPatrol = void 0;
...
var opposite = (_opposite = {}, _defineProperty(_opposite, BOTTOM, TOP), _defineProperty(_opposite, LEFT, RIGHT), _defineProperty(_opposite, RIGHT, LEFT), _defineProperty(_opposite, TOP, BOTTOM), _opposite);

var BorderPatrol = function BorderPatrol(_ref) {
  var children = _ref.children,
      style = _ref.style;

  var _useOverflowTracker = (0, _hooks.useOverflowTracker)(),
      _useOverflowTracker2 = _slicedToArray(_useOverflowTracker, 2),
      wrapperRef = _useOverflowTracker2[0],
      overflowOn = _useOverflowTracker2[1];

  var safeStyles = _objectSpread({}, style);
...
exports.BorderPatrol = BorderPatrol;
},{"react":"n8MK","../hooks":"FDhl"}],"ccgj":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.iconStyle = exports.errorStyle = exports.helpTextStyle = exports.requiredStyle = exports.inputStyle = exports.inputBlockStyle = exports.wrapperStyle = void 0;
...
var wrapperStyle = function wrapperStyle() {
  var overrides = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var labelBlockOnTop = arguments.length > 1 ? arguments[1] : undefined;
  return _objectSpread({
...
var inputBlockStyle = function inputBlockStyle(width, labelBlockOnLeft, labelBlockOnTop) {
  return {
    display: 'flex',
    flexDirection: 'column',
    flexShrink: width ? 0 : 1,
    // if users override width, it's because they want full control
...
var requiredStyle = function requiredStyle() {
  return {
    color: 'red'
  };
};

exports.requiredStyle = requiredStyle;

var helpTextStyle = function helpTextStyle() {
  return {
    color: 'grey',
    fontSize: '.8rem'
  };
...
var errorStyle = function errorStyle() {
  return {
    background: 'white',
...
var iconStyle = function iconStyle(iconLeft) {
  var styleObj = {
    position: 'absolute',
    right: '.5rem',
    top: '.4rem'
...
},{}],"vdtg":[function(require,module,exports) {
"use strict";
...
var Input = function Input(_ref) {
  var disabled = _ref.disabled,
      ...
      label = _ref.label,
      labelBlockOnTop = _ref.labelBlockOnTop,
  ...
  var uid = id || label;
  var labelBlockOnLeft = (label || helpText) && !labelBlockOnTop;
  return _react.default.createElement("div", {
    style: (0, _styles.wrapperStyle)(style, labelBlockOnTop)
  }, _react.default.createElement("div", null, required && _react.default.createElement("span", {
    style: (0, _styles.requiredStyle)()
  }, "* "), label && _react.default.createElement("label", {
    htmlFor: uid
  }, label), toolTip && _react.default.createElement(_.ToolTip, {
    content: toolTip,
    toolTipIcon: toolTipIcon
  }), helpText && _react.default.createElement("div", {
    style: (0, _styles.helpTextStyle)()
  }, helpText)), _react.default.createElement("div", {
...
exports.Input = Input;
},{"react":"n8MK","../":"tQm2","./styles":"ccgj"}],"IZqi":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toolTipStyle = exports.toolTipBockStyle = void 0;

var toolTipBockStyle = function toolTipBockStyle() {
  return {
...
exports.toolTipBockStyle = toolTipBockStyle;
...
},{}],"Ti0V":[function(require,module,exports) {
"use strict";
...
var ToolTip = function ToolTip(_ref) {
  ...
  var toggleHovered = function toggleHovered() {
    return setHovered(!hovered);
  };

  return _react.default.createElement("div", {
    style: (0, _styles.toolTipBockStyle)(),
    onMouseEnter: toggleHovered,
    onMouseLeave: toggleHovered
  }, toolTipIcon || '(?)', hovered && _react.default.createElement(_.BorderPatrol, {
    style: (0, _styles.toolTipStyle)()
  }, content));
};

exports.ToolTip = ToolTip;
},{"react":"n8MK","./styles":"IZqi","../":"tQm2"}],"tQm2":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "BorderPatrol", {
  enumerable: true,
  get: function () {
    return _BorderPatrol.BorderPatrol;
  }
});
...
Object.defineProperty(exports, "useOverflowTracker", {
  enumerable: true,
  get: function () {
    return _hooks.useOverflowTracker;
  }
});
Object.defineProperty(exports, "useWindowSize", {
  enumerable: true,
...
var _BorderPatrol = require("./BorderPatrol");
...
var _hooks = require("./hooks");
},{"./BorderPatrol":"Y8Wc","./Input":"vdtg","./ToolTip":"Ti0V","./hooks":"FDhl"}],"Cjld":[function(require,module,exports) {
"use strict";
...
var inputProps = [{
  ...
  examples: _react.default.createElement("ul", {
    style: listStyle
  ...
  types: ['string'],
  notes: _react.default.createElement("div", null, "Control the width of the actual input tag within the Input component", _react.default.createElement("br", null), "Any CSS width value"),
  examples: _react.default.createElement("ul", {
    style: listStyle
  ...
  types: ['object'],
  notes: _react.default.createElement("div", null, "Standard react inline css prop", _react.default.createElement("br", null), "Controls the main wrapper of the component", _react.default.createElement("br", null), "Largely used for positioning"),
  examples: _react.default.createElement("pre", {
    style: preStyle
  }, "\n    {\n      width: '55%',\n      margin: '5rem'\n    }\n      ")
}, {
  ...
  types: ['string', 'node'],
  notes: _react.default.createElement("div", null, "Wrapped in a ", '<BorderPatrol />', " component and positioned at the top-right of the icon.", _react.default.createElement("br", null), "BorderPatrol makes it so that the toolTip will always stays within the viewport", _react.default.createElement("br", null), "Any other styles can be applied by providing a styled component instead of a string"),
  examples: _react.default.createElement("pre", {
    style: preStyle
  }, "\u2219 Some descriptive sentence\n\u2219 <div style={{ background: \"white\" }}>\n    Mad <em>z-index</em> bro!\n  </div>")
}, {
  name: _react.default.createElement(_actualLibrary.ToolTip, {
    content: _react.default.createElement("div", {
      style: toolTipStyle
    }, "toolTipIcon can be plain text, like this..."),
    toolTipIcon: "toolTipIcon"
  }),
  types: ['string', 'node'],
  notes: _react.default.createElement("div", null, "If a value is provided to the toolTip prop but not to the toolTipIcon prop, it will default to: (?)", _react.default.createElement("br", null), "toolTipIcon without toolTip will be ignored"),
  examples: _react.default.createElement("ul", {
    style: listStyle
  }, _react.default.createElement("li", null, "\u2219 ", _react.default.createElement("i", {
  ...
  types: ['function'],
  notes: _react.default.createElement("span", null, "Receives the input field's value and must return ", _react.default.createElement("b", null, "true"), " when the value is ", _react.default.createElement("b", null, "not"), " valid"),
  examples: _react.default.createElement("ul", {
    style: listStyle
...
Object.defineProperty(exports, "demoBoxProps", {
  enumerable: true,
  get: function () {
    return _demoBoxProps.demoBoxProps;
  }
});
...
var _demoBoxProps = require("./demoBoxProps");

var _inputProps = require("./inputProps");
},{"./demoBoxProps":"uZ6V","./inputProps":"Cjld"}],"l9Zi":[function(require,module,exports) {
"use strict";
...
/* eslint-disable react/prop-types */
var NotARealButton = function NotARealButton(_ref) {
  var handleClick = _ref.handleClick,
      nested = _ref.nested;
  return _react.default.createElement("button", {
    onClick: function onClick() {
      return handleClick(nested);
    }
  }, "For demo's sake");
};

var Default = function Default() {
  return _react.default.createElement("div", null, _react.default.createElement("h1", null, "DemoBox"), _react.default.createElement(_nonShipped.DemoBox, null, _react.default.createElement(_nonShipped.DemoBox, {
    funcStrings: ['nested => nested()', '() => console.log(\'funcStrings accepts an array or a string\')']
  }, _react.default.createElement(NotARealButton, {
    handleClick: function handleClick(nested) {
      return nested();
    },
    nested: function nested() {
      return console.log('funcStrings accepts an array or a string');
    }
  }))), _react.default.createElement("h2", null, "Props"), _react.default.createElement(_nonShipped.PropsTable, {
    props: _propTypes.demoBoxProps
  }));
};

var _default = Default;
exports.default = _default;
},{"react":"n8MK","./nonShipped":"JAGQ","../propTypes":"D9iF"}],"JQhx":[function(require,module,exports) {
"use strict";
...
var settersStyle = function settersStyle(windowWidth) {
  return {
...
var InputExamples = function InputExamples() {
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(Section, null, _react.default.createElement(_actualLibrary.Input, {
    ...
    toolTip: _react.default.createElement("div", {
      style: toolTipStyle
    }, "Some toolTip message that can be a styled component or a string"),
    toolTipIcon: _react.default.createElement("i", {
      className: "far fa-question-circle"
    }),
    ...
    placeholder: placeholder,
    validation: function validation(text) {
      return text.toLowerCase().indexOf('fuck') !== -1;
    },
    ...
    text: "disabled"
  }), " prop is true, the ", _react.default.createElement(Badge, {
    text: "placeholder"
    ...
    id: "id"
  }, "Because this example uses the same \"", label, "\" label as the input above, we run into the ", _react.default.createElement(Badge, {
    text: "[DOM] Found 2 elements with non-unique id"
  }), " error", _react.default.createElement("br", null), "(Again, the input's ", _react.default.createElement(Badge, {
    text: "id"
  }), " defaults to the ", _react.default.createElement(Badge, {
    text: "label"
  }), "'s value if it is not explicitly defined)", _react.default.createElement("br", null), "This is a use case for the ", _react.default.createElement(Badge, {
    text: "id"
    ...
    text: "label"
  }), " prop will be defined and the label will be on the left", _react.default.createElement("br", null), "The main wrapper being a flex blox, if ", _react.default.createElement(Badge, {
    text: "label"
  }), " is undefined it looks like the inner input field floats right:"), _react.default.createElement(_nonShipped.DemoBox, null, _react.default.createElement(_actualLibrary.Input, {
    inputWidth: "50%"
  })), _react.default.createElement("p", null, "Passing the ", _react.default.createElement(Badge, {
    text: "labelBlockOnTop"
  }), " prop is equivalent to changing the flex-direction on the main wrapper (from row to column):"), _react.default.createElement(_nonShipped.DemoBox, null, _react.default.createElement(_actualLibrary.Input, {
    labelBlockOnTop: true,
    inputWidth: "50%"
  })), _react.default.createElement("p", {
    id: "style"
  }, "If you prefer to be more explicit about things, just override with the ", _react.default.createElement(Badge, {
    text: "style"
  }), " prop", _react.default.createElement("br", null), "Understand that the ", _react.default.createElement("b", null, "style"), " object will only be applied to the main wrapper (hence the separate ", _react.default.createElement(Badge, {
    text: "inputWidth"
  }), " prop)", _react.default.createElement("br", null), "It's just flexbox under the hood: ", _react.default.createElement("button", {
    onClick: toggleAlignItems
  }, "Click me!")), _react.default.createElement(_nonShipped.DemoBox, null, _react.default.createElement(_actualLibrary.Input, {
    inputWidth: "25%",
    style: flexStyle()
    ...
    text: "validation"
  }), " prop accepts a function. This function's sole concern should be to notify the component when the input is invalid, therefore it must return true on invalid, false otherwise", _react.default.createElement("br", null), "It receives only 1 argument: the input value"), _react.default.createElement(_nonShipped.DemoBox, {
    funcStrings: 'text => text === \'LOL\''
  }, _react.default.createElement(_actualLibrary.Input, {
    validation: function validation(text) {
      return text === 'LOL';
    },
    ...
    text: "errorMessage"
  }), " prop is there to override this default"), _react.default.createElement(_nonShipped.DemoBox, {
    funcStrings: 'text => text === \'LOL\''
  }, _react.default.createElement(_actualLibrary.Input, {
    validation: function validation(text) {
      return text === 'LOL';
...
_reactDom.default.render(_react.default.createElement(_App.default, null), document.getElementById('demo')); // Hot Module Replacement
// Delete for full refresh on save
